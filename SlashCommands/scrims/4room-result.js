...
module.exports = {
  name:"4room-result",
  description:"to calculate scrim result in 4 rooms",
  options: [{
    name: "team-name" ,
    ...
    name: "room4-place" ,
    description : "place in room4",
    type: 4,
    required: true,
  },{
    name: "room4-kills" ,
    description : "kills in room4",
    type: 4,
    required: true,
  }],
  ...
  let aroom4 = interaction.options.getInteger("room4-place")
  ...
  let kroom4 = interaction.options.getInteger("room4-kills")
    ...
    if (aroom4 == 1) aroom4 = 20
    else if (aroom4 == 2) aroom4 = 14
    else if (aroom4 == 3) aroom4 = 10
    else if (aroom4 == 4) aroom4 = 8
    else if (aroom4 == 5) aroom4 = 7
    else if (aroom4 == 6) aroom4 = 6
    else if (aroom4 == 7) aroom4 = 5
    else if (aroom4 == 8) aroom4 = 4
    else if (aroom4 == 9) aroom4 = 3
    else if (aroom4 == 10) aroom4 = 2
    else if (aroom4 == 11) aroom4 = 1
    else if (aroom4 == 12) aroom4 = 1
    else if (aroom4 == 13) aroom4 = 1
    else if (aroom4 == 14) aroom4 = 1
    else if (aroom4 == 15) aroom4 = 1
    else if (aroom4 == 6) aroom4 = 1
    else aroom4 = 0


    let killPoints = Math.floor( (kroom1) + (kroom2) + (kroom3) + (kroom4) )
    let SurvivePoints = Math.floor( (aroom1) + (aroom2) + (aroom3) + (aroom4) )
    let totalPoints = Math.floor( (killPoints) + (SurvivePoints) )

    if (aroom1 === 20 && aroom2 === 20 && aroom3 === 20 && aroom4 === 20) {
...
𝐓𝐨𝐭𝐚𝐥 𝐏𝐨𝐢𝐧𝐭𝐬 : ${totalPoints}`)
    ...
    if (aroom1 === 20 && aroom3 === 20 && aroom4 === 20) {
      interaction.editReply(`
𝐓𝐞𝐚𝐦 𝐍𝐚𝐦𝐞 : ${teamname}
𝐖𝐖𝐂𝐃 : 3
𝐒𝐮𝐫𝐯𝐢𝐯𝐞 𝐏𝐨𝐢𝐧𝐭𝐬 : ${SurvivePoints}
...
𝐓𝐨𝐭𝐚𝐥 𝐏𝐨𝐢𝐧𝐭𝐬 : ${totalPoints}`)
  ...
  if (aroom1 === 20 && aroom2 === 20 && aroom4 === 20) {
      interaction.editReply(`
𝐓𝐞𝐚𝐦 𝐍𝐚𝐦𝐞 : ${teamname}
𝐖𝐖𝐂𝐃 : 3
𝐒𝐮𝐫𝐯𝐢𝐯𝐞 𝐏𝐨𝐢𝐧𝐭𝐬 : ${SurvivePoints}
